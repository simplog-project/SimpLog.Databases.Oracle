...
using static SimpLog.Databases.Oracle.Models.Constants;

namespace SimpLog.Databases.Oracle.Services.FileServices
{
    internal class FileService
    {
        ...
        public static Configuration configuration = ConfigurationServices.ConfigService.BindConfigObject();
            ...
            try
            {
                ...
                if (ShouldSaveInDb(saveInDatabase, logType))
                    DatabaseServices.DatabaseServices.SaveIntoDatabase(
                        ...
                        storeLog(message, isEmailSent, logType, saveInDatabase, FileSaveType.DontSave, "", ""),
